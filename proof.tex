...
\item Case: \( \langle H, R, \scon\Sirx s, n, C \rangle
  ...
  and \rn{T-Sub}, \( \Theta; \Gamma \vdash s;\Endconst:P'\) holds.
...
\item Case: \( \langle H, R, \LET x = \MALLOC \IN s, n, C \rangle
  ...
  \(OK_{n-1}(P', F')\) hold. We also have \(\Theta;[x'/x]\Gamma \vdash
      [x'/x]s \COL P'\) from \rn{T-Sub}, \(\Theta;[x'/x]\Gamma \vdash
...
\item Case: \( \langle H, R, \SKIP;s, n, C \rangle \rightarrow \langle
  ...
  have \(\Theta;\Gamma \vdash s\COL P'\) from \rn{T-Sub}, \(\Gamma
