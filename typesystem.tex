...
\infax[Tr-Skip]
{ \langle {\bf 0};P, C \rangle \rightarrow \langle P, C \rangle }
...
\begin{minipage}{0.5\textwidth}
\infax[Tr-Free]
{ \langle \Free, C \rangle \xlongrightarrow{\Free} \langle {\bf 0}, C \rangle }
\end{minipage}
\begin{minipage}{0.5\textwidth}
\infax[Tr-Rec]
...
\begin{minipage}{0.5\textwidth}
\infax[Tr-ChoiceL]
{ \langle P_1 + P_2, C \rangle \rightarrow \langle P_1, C \rangle }
\end{minipage}
\begin{minipage}{0.5\textwidth}
\infax[Tr-ChoiceR]
{ \langle P_1 + P_2, C \rangle \rightarrow \langle P_2, C \rangle }
\end{minipage}
...
\infax[Tr-Malloc]
{ \langle  \Malloc, C \rangle \xlongrightarrow{\Malloc} \langle 0, C \rangle }
...
\infax[Tr-Const]
{ \langle \scon\Sirx P, C \rangle \rightarrow \langle P;\Endconst, C\cup \{\scon\Sirx\} \rangle }
...
%% \begin{myDef}
%% \label{df:okf}
%% \(OK(C)\) holds, if \(\scon\Sirx \in C \), then \(C\) does not contain both \( \snull \) and \( \snnull \).
%% \end{myDef}
...
{\Theta ; \Gamma \vdash \LET x = \MALLOC \; \IN s :\Malloc \;(x)P}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\infrule[T-LetEq]
...
% Program
\infrule[T-Program]
{\vdash D : \Theta \andalso \Theta; \emptyset\vdash s : P \Rtab OK_{n}(P, C)}
