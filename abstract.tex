...
%% In the previous work, we proposed a behavioral type system for a
%% programming language with dynamic memory allocation and
%% deallocation. The behavioral type system, which uses sequential
...
%% extension of the previous type system with dependent types. We prove
%% the soundness of the extended type system and propose a type inference
%% algorithm of this type system. We also implemented the algorithm.
